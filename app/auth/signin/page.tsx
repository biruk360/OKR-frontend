    ...
    >
      ...
      >
        ...
        <form className="mt-6 space-y-4" onSubmit={handleSubmit}>
          {error && (
            <div
              className="rounded-[var(--ap-radius-sm)] px-3 py-2 text-[12px] font-medium"
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full rounded-[var(--ap-radius-sm)] border-0 pl-9 pr-9 py-2 text-[13px] outline-none focus:ring-2 focus:ring-[color:var(--ap-accent)]"
                style={{ background: 'rgba(120,120,128,0.06)' }}
              />
              <button
                type="button"
