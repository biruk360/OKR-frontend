  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        {(session.user.role === 'ADMIN' || session.user.role === 'EXECUTIVE' || session.user.role === 'DEPARTMENT_LEAD') && (
          <CreateDepartmentObjectiveButton />
        )}
      </div>

      {/* Department OKR Stats */}
          ...
          <div className="p-5">
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  <dt className="text-sm font-medium text-gray-500 truncate">Department Objectives</dt>
