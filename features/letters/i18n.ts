...
const STRINGS = {
  en: {
    ...
    'form.signatoryTitle': 'Signatory Title / Position',
    'form.signatoryTitle.placeholder': 'e.g. General Manager',
  ...
  am: {
    ...
    'form.signatoryTitle': 'የፈራሚ ማዕረግ / ቦታ',
    'form.signatoryTitle.placeholder': 'ለምሳሌ፦ ጠቅላላ ሥራ አስኪያጅ',
